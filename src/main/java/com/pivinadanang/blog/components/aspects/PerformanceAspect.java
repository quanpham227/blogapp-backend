package com.pivinadanang.blog.components.aspects;
...
public class PerformanceAspect {
    ...
    //@Pointcut("within(com.pivinadanang.blog.controller.*)")
    //@Pointcut("within(com.pivinadanang.blog.controller.CategoryController)")
