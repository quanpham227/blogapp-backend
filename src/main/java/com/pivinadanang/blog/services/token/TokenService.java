...
public class TokenService implements ITokenService {
    ...
    @Transactional
    @Override
    public Token addToken(UserEntity user, String token, boolean isMobileDevice) {
    ...
    @Transactional
    @Override
    public Token refreshToken(String refreshToken, UserEntity user) throws Exception {
        ...
        tokenRepository.save(existingToken); // Save the updated token
