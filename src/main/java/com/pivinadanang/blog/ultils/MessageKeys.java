...
public class MessageKeys {
    ...
    public static final String INSERT_POST_SUCCESSFULLY = "post.create_post.create_successfully";
    public static final String DELETE_POST_SUCCESSFULLY = "post.delete_post.delete_successfully";
